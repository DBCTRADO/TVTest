...
const CColorScheme::ColorInfo CColorScheme::m_ColorInfoList[NUM_COLORS] = {
	...
	{HEXRGB(0x111111),  TEXT("EventInfoPopupBack"),                TEXT("番組情報ポップアップ 背景")},
	{HEXRGB(0xBBBBBB),  TEXT("EventInfoPopupText"),                TEXT("番組情報ポップアップ 文字")},
	{HEXRGB(0xDDDDDD),  TEXT("EventInfoPopupEventTitle"),          TEXT("番組情報ポップアップ 番組名")},
