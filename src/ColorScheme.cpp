...
const CColorScheme::ColorInfo CColorScheme::m_ColorInfoList[NUM_COLORS] = {
	...
	{HEXRGB(0x111111),	TEXT("ProgramInfoBack"),					TEXT("情報パネル 番組背景")},
	{HEXRGB(0xAAAAAA),	TEXT("ProgramInfoText"),					TEXT("情報パネル 番組文字")},
	...
	for (i=0;i<NUM_COLORS;i++) {
		if (IsLoaded(i)) {
			...
			//	{COLOR_PANELTITLEBORDER,					COLOR_PANELTITLEBACK1},
				...
				{COLOR_CHANNELPANEL_PROGRESS1,				COLOR_STATUSEVENTPROGRESSELAPSED1},
				{COLOR_CHANNELPANEL_PROGRESS2,				COLOR_STATUSEVENTPROGRESSELAPSED2},
				{COLOR_CHANNELPANEL_PROGRESSBORDER,			COLOR_CHANNELPANEL_PROGRESS1},
				{COLOR_CHANNELPANEL_CURPROGRESS1,			COLOR_CHANNELPANEL_PROGRESS1},
				{COLOR_CHANNELPANEL_CURPROGRESS2,			COLOR_CHANNELPANEL_PROGRESS2},
				...
				{COLOR_CONTROLPANELCHECKEDBACK1,			COLOR_CONTROLPANELHIGHLIGHTBACK1},
				{COLOR_CONTROLPANELCHECKEDBACK2,			COLOR_CONTROLPANELHIGHLIGHTBACK2},
