...
static const struct {
	...
	{{L"再生",			NULL,					{26,184,28,14}, { 16,22}},	VK_F13,		MK_CONTROL | MK_SHIFT},
	...
	{{L"A (青)",		NULL,					{ 8,230,16,11}, { 44,22}},	VK_F21,		MK_CONTROL | MK_SHIFT},
	{{L"B (赤)",		NULL,					{24,230,16,11}, { 60,22}},	VK_F22,		MK_CONTROL | MK_SHIFT},
	{{L"C (緑)",		NULL,					{40,230,16,11}, { 76,22}},	VK_F23,		MK_CONTROL | MK_SHIFT},
	{{L"D (黄)",		NULL,					{56,230,16,11}, { 92,22}},	VK_F24,		MK_CONTROL | MK_SHIFT},
#if 0
